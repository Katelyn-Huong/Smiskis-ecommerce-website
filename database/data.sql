...
-- INSERT INTO "smiskis" ("seriesId", "bodyType", "pose", "found", "description") VALUES
-- (2 'Normal', 'Staring into space', 'Nearby walls', 'Likes to daydream all day long. Most of the time, this Smiski is lost in its in world');
...
-- INSERT INTO "smiskis" ("seriesId", "bodyType", "pose", "found", "description") VALUES
-- (4, 'Chubby', 'Stuck', 'In the gap between things', 'A Smiski who got stuck on a way to somewhere. It seems that it can not grasp that its body size.');
